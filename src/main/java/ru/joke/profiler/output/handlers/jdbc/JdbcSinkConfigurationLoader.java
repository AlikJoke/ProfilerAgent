...
final class JdbcSinkConfigurationLoader {
    ...
    private JdbcSinkConfiguration.OutputTableConfiguration loadOutputTableConfiguration(final Map<String, String> properties) {
        ...
        final boolean autoCreateTable = properties.getOrDefault(STATIC_JDBC_SINK_AUTO_CREATE_OUTPUT_TABLE, "").isEmpty()
                || parseBooleanProperty(properties, STATIC_JDBC_SINK_AUTO_CREATE_OUTPUT_TABLE);
