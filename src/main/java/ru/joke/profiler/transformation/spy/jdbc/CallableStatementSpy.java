...
final class CallableStatementSpy extends PreparedStatementSpy<CallableStatement> implements CallableStatement {
    ...
    CallableStatementSpy(
        ...
        super(delegate, registrar, configuration, query);
    }
